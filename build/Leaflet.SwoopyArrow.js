...
L$1.SwoopyArrow = L$1.Layer.extend({
  ...
  initialize: function initialize(fromLatlng, toLatlng, options) {
    ...
    this._labelAt = this.options.labelAt;
  ...
  _drawSwoopyArrows: function _drawSwoopyArrows() {
    ...
    this._currentMarker = L$1.marker([this['_' + this._labelAt + 'Latlng'].lat, this['_' + this._labelAt + 'Latlng'].lng], { icon: swoopyLabel }).addTo(this._map);
  },
